...
.. code-block:: bash
   ...
   $ reclib train --help
    usage: reclib train [-h] -s SERIALIZATION_DIR [-r] [-f] [-o OVERRIDES]
...
from reclib.training.util import create_serialization_dir, evaluate
...
def train_model_from_file(parameter_filename: str,
    ...
    parameter_filename : ``str``
        A json parameter file specifying an RecLib experiment.
    serialization_dir : ``str``
    ...
    cache_directory : ``str``, optional
        For caching data pre-processing.  See :func:`reclib.training.util.datasets_from_params`.
...
def train_model(params: Params,
    ...
    if trainer_type == "default":
        ...
        if evaluate_on_test:
            raise ValueError("--evaluate-on-test only works with the default Trainer. "
                             ...
                             "to run reclib evaluate separately.")
    ...
    if evaluation_dataset and evaluate_on_test:
        ...
        logger.info("To evaluate on the test set after training, pass the "
                    "'evaluate_on_test' flag, or use the 'reclib evaluate' command.")
