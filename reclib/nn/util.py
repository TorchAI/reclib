...
def batched_index_select(
    ...
    :class:`~reclib.models.coreference_resolution.CoreferenceResolver`. Model to select
...
def find_embedding_layer(model: torch.nn.Module) -> torch.nn.Module:
    ...
    from reclib.modules.text_field_embedders.text_field_embedder import TextFieldEmbedder
    from reclib.modules.text_field_embedders.basic_text_field_embedder import (
        BasicTextFieldEmbedder,
    )
    from reclib.modules.token_embedders.embedding import Embedding
